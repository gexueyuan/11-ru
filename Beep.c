...
#define N  7
#define ScreenMask 21
#define TestMask   21  //21//0.01   //42//0.02    //15//0.007     //105//0.05   //42//0.02
...
if(TestMode==0xcc)/*快测*/
     ...
     if(Cons<ScreenMask)
	 	...
	 	{
	    if((Cons<200)&&(Cons>=100))Cons=Cons+10;           	
	      alocholdetecet=TRUE;
	 	}
		}
	if(Cons<TestMask)Cons=0;
