...
goto_test:		if((!directionZYQ))
	...
	case CREATE_RECORD:
        ...
        case DISPLAY_RECORD:
			...
			if((PORTCbits.RC1)&&(WndGetText(pWin)==RecordBKStr))
				{
...
XCHAR SoftwareID[] = {'V',':',' ','1','0','3','1','1','1','0','1','0',0};
...
XCHAR edition[] = {'R','U',0x0020,'V','1','.','0','4',0,0,0};//{0x43,0x4e,0x20,0x56,0x31,0x2e,0x30,0x30,0x00};//"CN V1.00"; //edition
